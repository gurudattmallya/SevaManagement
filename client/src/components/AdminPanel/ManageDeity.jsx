      ...
      <div className="max-w-6xl mx-auto">
        ...
        <Modal isOpen={isViewModalOpen} onClose={closeViewModal}>
         {selectedDeity && (
            <div className="p-6">
              <div className="flex justify-between items-center mb-4">
                <h2 className="text-xl font-bold text-gray-800">Deity Details</h2>
              ...
              <div className="space-y-3">
                <div className="grid grid-cols-2 gap-4">
                  ...
                  <div className="space-y-1">
                    ...
                    <p className="font-medium">{selectedDeity.special_occasions ? 'Yes' : 'No'}</p>
                  </div>
                </div>
             ...
             <table className="w-full">
               <thead>
                 <tr className="bg-orange-600 text-white">
                   ...
                   <th className="px-6 py-3 text-left text-sm font-medium">Special Occasions</th>
               ...
               <tbody className="divide-y divide-gray-200">
                 {deities.map((deity) => (
                  <tr key={deity.id} className="hover:bg-orange-50">
                    <td className="px-6 py-4 text-sm text-gray-900">{deity.id}</td>
                    <td className="px-6 py-4 text-sm font-medium text-gray-900">{deity.name}</td>
