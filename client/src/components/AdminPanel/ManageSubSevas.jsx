...
//   //   try {
//   //     const response = await axios.get(`${API_BASE_URL}/sub-sevas/parent-sevas/list`, authHeaders);
//   //     setParentSevas(response.data);
//   //   } catch (err) {
//   //     showNotification("Failed to load parent sevas", "error");
//   //   }
//   // };
// // In ManageSubSevas.jsx
// const fetchParentSevas = async () => {
//   try {
...
//   //   try {
//   //     const response = await axios.get(`${API_BASE_URL}/sub-sevas/deities/${sevaType}`, authHeaders);
//   //     setDeities(response.data);
//   //   } catch (err) {
//   //     showNotification("Failed to load deities", "error");
//   //   }
//   // };
//   // const fetchDeities = async (sevaType) => {
//   //   try {
...
//   //       }
//   //     });
//   //     console.log('Deities response:', response.data);
//   //     setDeities(response.data);
//   //   } catch (err) {
//   //     console.error('Deity fetch error:', err.response?.data || err.message);
//   //     showNotification("Failed to load deities", "error");
//   //   }
//   // };
//   // const fetchDeities = async (sevaType) => {
...
//   //     // Handle multiple deities from the response
//   //     const deitiesData = response.data.data;
//   //     const deitiesArray = Array.isArray(deitiesData) ? deitiesData : [deitiesData];
//   //     console.log('Deities array:', deitiesArray);
...
//                 <tr>
//                   <th className="px-6 py-3 text-left text-sm font-semibold text-orange-600">ID</th>
//                   <th className="px-6 py-3 text-left text-sm font-semibold text-orange-600">Parent Seva</th>
//                   <th className="px-6 py-3 text-left text-sm font-semibold text-orange-600">Deity</th>
//                   <th className="px-6 py-3 text-left text-sm font-semibold text-orange-600">Name</th>
//                   <th className="px-6 py-3 text-left text-sm font-semibold text-orange-600">Price</th>
//                   <th className="px-6 py-3 text-left text-sm font-semibold text-orange-600">Status</th>
//                   <th className="px-6 py-3 text-left text-sm font-semibold text-orange-600">Type</th>
//                   <th className="px-6 py-3 text-left text-sm font-semibold text-orange-600">Actions</th>
//                 </tr>
//               </thead>

// <tbody className="bg-white divide-y divide-orange-100">
//   {subSevas.map((subSeva) => (
//     <tr key={subSeva.SEVA_CODE} className="hover:bg-orange-50 transition-colors">
//       <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-700">
//         {subSeva.SEVA_CODE}
//       </td>
//       <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-700">
//   {subSeva.PARENT_SEVA_NAME}
// </td>
...
//           className="w-full mt-4 bg-gradient-to-r from-orange-500 to-orange-600 hover:from-orange-600 hover:to-orange-700 text-white font-medium py-2 px-4 rounded-md transition-colors"
//         >
//           Back
//         </button>
