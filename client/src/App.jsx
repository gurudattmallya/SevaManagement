        ...
        <Route path="/*" element={
          <AuthenticatedLayout>
            <Routes>
              ...
              <Route path="admin/manage/deity" element={
                <ProtectedRoute>
                  <ManageDeity />
                </ProtectedRoute>
              } />
              <Route path="admin/manage/master-sevas" element={
                <ProtectedRoute>
                  <ManageMasterSevas />
                </ProtectedRoute>
              } />
              <Route path="admin/manage/special-sevas" element={
                <ProtectedRoute>
                  <ManageSpecialSevas />
                </ProtectedRoute>
              } />
              <Route path="admin/manage/sub-sevas" element={
                <ProtectedRoute>
                  <ManageSubSevas />
                </ProtectedRoute>
              } />
              {/* Protected Admin Routes */}
              <Route path="admin/manage/statistics" element={
  <ProtectedRoute>
    <ManageStatistics />
  </ProtectedRoute>
} />
